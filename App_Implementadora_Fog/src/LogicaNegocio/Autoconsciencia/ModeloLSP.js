...
const table = {
  ...
  // // Ejemplo de uso:
  // const operacion = "D--";
  // const pesos = [2.3, 4.6, 4];
  // const metricas = [5.4, 2.7, 5];
  
  // const resultado = modeloLSP(operacion, pesos, metricas);
  // console.log(resultado); // Debería imprimir -1.655 en este ejemplo
