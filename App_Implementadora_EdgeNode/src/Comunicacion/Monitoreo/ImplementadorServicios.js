...
const protocolos = require('../../LogicaNegocio/Monitoreo/ImplementadorApis')
const app = require('../../LogicaNegocio/Monitoreo/ImplementadorAplicaciones')
                                    ...
                                    if(df==="//@"+propertyColumnr){
                                        ...
                                        if(!result){
                                            if(sourceColumn === "cargaCPU"){
                                                result = require('../../LogicaNegocio/Monitoreo/ImplementadorApis').obtenerCargaCPU().cargaCPU;
