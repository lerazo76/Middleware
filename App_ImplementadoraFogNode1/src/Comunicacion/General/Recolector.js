...
app.post('/',(req, res) =>{ 
    ...
    if(req.body){
        try{
            ...
            fs.writeFile('../../../modelos/modeloObjeto.json', JSON.stringify(req.body.modeloOBJETO, null, 4), 'utf-8', (err) =>{ //cambiar la ruta aqui para que se cree ../../../modelos/modeloObjeto.json
                if(err){
                    response = {
                        error: true,
                        code: 502,
